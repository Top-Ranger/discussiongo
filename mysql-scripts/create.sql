...
CREATE TABLE discussiongo.events (id BIGINT UNSIGNED AUTO_INCREMENT, type BIGINT UNSIGNED NOT NULL, user VARCHAR(600) NOT NULL, topic TEXT, date BIGINT UNSIGNED NOT NULL, data BLOB, affecteduser VARCHAR(600), PRIMARY KEY(id));
